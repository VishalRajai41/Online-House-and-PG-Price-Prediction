...
if(empty($_SESSION['user']))
    header("location:login.php");
          ...
          $uid=$_SESSION['uid'];
          $result=@mysqli_query($con,"select * from house_and_pg_price where sale_rent='Sale' and oid='$uid' ") or die(mysql_error($con));
                    ...
                    <div class="col-lg-9">
                        <nav class="nav-menu">
                            <ul>
                                ...
                                <li class="active" ><a href="sale.php">Your Sale</a></li>
                    ...
                    <div class="wrap-table100">
                        <div class="table100">
                            <table>
                                ...
                                <tbody>
                                    <?php
                                        $result1=@mysqli_query($con,"select * from house_and_pg_price where sale_rent='Sale' and oid='$uid' ") or die(mysql_error($con));
