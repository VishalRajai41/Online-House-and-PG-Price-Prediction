...
$result=mysqli_query($con,"select * from user_m where u_type='Owner'") or die(mysql_error($con));
?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="table1/css/style.css">
    <meta charset="UTF-8">
               ...
               <div class="mobile"><i class="fa fa-bars"></i><i class="fa fa-times"></i></div>
                <div class="menumobile">
                    ...
                    <nav class="Navigation">
                        <ul>
                            <li class="active">                                
                                <a href="home.php">Owner<br>Detail</a>
                            ...
                            <li>
                                <a href="addlocation/index.php">Add<br>Location</a>
                                <span class="menu-item-bg"></span>
                            </li>
                            <li>
...
<h1><span class="blue">Owner's</span><span class="yellow">Detail</pan></h1>
...
<table class="container">
 ...
 <!-- \\ Begin Get Section \\ -->
    ...
    <!-- <<Attched Javascripts>> -->
<script type="text/javascript" src="table1/nav/js/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="table1/nav/js/jquery.sudoSlider.min.js"></script>
<script type="text/javascript" src="table1/nav/js/global.js"></script>
<script type="text/javascript" src="table1/nav/js/modernizr.js"></script>
