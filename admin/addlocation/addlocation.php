...
/*$result1=mysqli_query($con,"select * from state where sid=$listcategory ") or die(mysqli_error($con));
...
function loadsubcategory(str) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
               // document.getElementById("tstate").innerHTML = this.responseText;
        ...
        xmlhttp.open("GET", "state.php?id=" + str, true);
        xmlhttp.send();*/
               ...
               <div class="mobile"><i class="fa fa-bars"></i><i class="fa fa-times"></i></div>
                <div class="menumobile">
                    ...
                    <nav class="Navigation">
                        <ul>
                            <li>                                
                                <a href="../home.php">Owner<br> Details</a>
                            ...
                            <li class="active">
                                <a href="index.php">Add<br> Location</a>
                                <span class="menu-item-bg"></span>
                            </li>
                            <li>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        ...
        <thead>
            <tr>
                ...
                <center><th><h1>City</h1></th></center>
                <!--<th><h1>Email</h1></th>
