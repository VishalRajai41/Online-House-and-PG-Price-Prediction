                    ...
                    <div class="col-lg-9">
                        <nav class="nav-menu">
                            <ul>
                                ...
                                <li class="active"><a href="houseandpgdetail.php">Add Details</a></li>
      ...
      <div class="card-body">
        <form id="registration_form" name="frm" method="post" enctype="multipart/form-data">
         ...
         <div class="form-row m-b-55">
            <div class="name">Featured Image</div>
            <div class="value">
