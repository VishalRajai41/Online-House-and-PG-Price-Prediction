...
if(empty($_SESSION['user']))
    header("location:login.php");
        ...
        $result=mysqli_query($con,"select a.house_pg_name,a.house_pg_city,a.house_pg_room,a.house_pg_photo,b.h_p_price,c.statename  from house_and_pg_price a,booking b,state c where a.h_p_id=b.h_p_id and b.u_id='$uid' and c.sid=a.house_pg_state ") or die(mysqli_error($con));  
                    ...
                    <div class="col-lg-9">
                        <nav class="nav-menu">
                            <ul>
                                ...
                                <li class="active" ><a href="yourbooking.php">Your Participate</a></li>
                            ...
                            <table>
                                <thead>
                                    <tr class="table100-head">
                                        <th class="column1">House Or Pg Image</th>
                                        <th class="column2">House Or Pg Name</th>
                                        <th class="column3">House Or Pg State</th>
                                        <th class="column4">House Or Pg City</th>
                                        <th class="column6">House Or Pg Room</th>
                                        <th class="column7">House Or Pg Price</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        while ($row=mysqli_fetch_array($result)) {
                                            # code...
                                             ...
                                             /*echo "<td class='column7'>$row[8]</td>";*/
                                             echo "</tr>";
                                        }
                                    ?>                               
